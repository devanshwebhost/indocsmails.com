      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-200">
            <li><a href="/error" className="hover:text-white">Documentation</a></li>
            <li><a href="/blogs" className="hover:text-white">Blogs</a></li>
            <li><a href="/error" className="hover:text-white">Developer Feedback</a></li>
            <li><a href="https://indocsmedia.onrender.com" className="hover:text-white">Indocs<span className='text-[#08b3ca] '>Media</span></a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-200">
            <li><a href="mailto:indocsmedia@gmail.com" className="hover:text-white">support@indocs<span className='text-[#08b3ca] '>media</span>.com</a></li>
            <li><a href="/error" className="hover:text-white">Terms & Conditions</a></li>
            <li><a href="/error" className="hover:text-white">Privacy Policy</a></li>
            <li><a href="/error" className="hover:text-white">API Status</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex space-x-4 mt-2">
            ...
            <a href="#" className="hover:text-yellow-300" title="GitHub">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="#" className="hover:text-yellow-300" title="LinkedIn">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
